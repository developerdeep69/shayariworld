 ...
 */
class Web_Artist_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    <label>
      ...
      <?php endif; ?>
       <select <?php $this->link(); ?>>
			<?php
			printf( '<option value="%s" %s>%s</option>', '', selected( $this->value(), '', false ), esc_html__('--None--', 'web-artist') );
			?>
 ...
 * @see WP_Customize_Control
 */
class Web_Artist_Dropdown_Category_Control extends WP_Customize_Control {
...
class Web_Artist_Note_Control extends WP_Customize_Control {
...
class Web_Artist_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Web_Artist_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="web-artist-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class Web_Artist_Multiple_Dropdown_Chooser extends WP_Customize_Control{
	public $type = 'dropdown_chooser';
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="web-artist-chosen-select" <?php $this->link(); ?> multiple>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class Web_Artist_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Web_Artist_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="web-artist-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'web-artist' ); ?>" class="web-artist-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
class Web_Artist_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Web_Artist_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
