...
class Web_Artist_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'web_artist';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'web-artist' ), $i ),
	...
	function get_footer_widgets_content( $args ) {
		...
		$args = wp_parse_args( (array) $args, array(
			'container'       => 'div',
			'container_class' => $this->custom_footer_widget_class( 'footer-widgets-area page-section no-padding-bottom' ),
			'container_style' => '',
			'container_id'    => '',
			'wrap_class'      => 'hentry',
			'before'          => '',
...
// Initialize.
$web_artist_footer_widgets = new Web_Artist_Footer_Widgets();
